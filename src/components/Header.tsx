            ...
            <div className="flex-1 min-w-0 flex items-center justify-between sm:justify-start gap-2 sm:gap-3">
              ...
              {currentOffer ? (
                ...
                <div className="flex items-center gap-2 text-[11px] sm:text-xs">
                  <span className="font-semibold text-[#2DD4BF]">Coastal Tails - Pet Aura</span>
                  <span className="hidden sm:inline text-slate-300">•</span>
                  <span className="hidden sm:inline text-slate-200">Shop No:B2, Dwaraka Enclave, Derebail</span>
                </div>
              )}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-18 lg:h-20 gap-2 sm:gap-4">
          ...
          <button
            ...
            className="flex items-center text-left group focus:outline-none cursor-pointer select-none shrink-0"
            aria-label="Coastal Tails - Pet Aura Home"
          >
        ...
        <div className="lg:hidden fixed inset-x-0 top-[calc(100%)] z-50 bg-slate-900/50 backdrop-blur-xs h-[calc(100vh-100%)] overflow-y-auto">
          <div className="bg-white border-b border-slate-200 shadow-2xl rounded-b-3xl p-4 sm:p-6 space-y-4 max-h-[85vh] overflow-y-auto animate-fadeIn">
            ...
            <div className="bg-[#F6EBD7]/50 p-3.5 rounded-2xl border border-[#F2B45E]/30 space-y-2 text-xs text-slate-600">
              ...
              <p className="text-slate-600 font-medium text-[11px]">{COASTAL_TAILS_SHOP_NO}, Derebail, Mangaluru</p>
              <a
            ...
            <div className="pt-2 flex flex-col gap-2">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3.5 bg-[#169DB1] hover:bg-[#1D237A] text-white rounded-2xl text-sm font-bold shadow-md shadow-[#169DB1]/20 transition-all cursor-pointer"
              >
              ...
              <div className="flex items-center justify-between pt-1">
                <a
                  href="tel:+917996989956"
                  className="flex items-center gap-1.5 text-xs text-slate-700 font-bold hover:text-[#169DB1] p-2"
                >
                  <Phone className="w-3.5 h-3.5 text-[#169DB1]" />
